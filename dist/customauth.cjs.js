/******/ (() => {
  ...
  var CONTRACT_MAP =
    ...
    defineProperty_default()(
      _CONTRACT_MAP,
      fetch_node_details_namespaceObject.TORUS_NETWORK.CELESTE,
      fetch_node_details_default().PROXY_ADDRESS_CELESTE
    ),
    _CONTRACT_MAP);
  var SIGNER_MAP =
    ((_SIGNER_MAP = {}),
    ...
    defineProperty_default()(_SIGNER_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.CELESTE, "https://signer-polygon.tor.us"),
    _SIGNER_MAP);
  var SENTRY_TXNS = {
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 17:
                        ...
                        loglevel.warn(_context2.t0, "Session likely expired");
                        _context2.next = 24;
                        break;
                      case 23:
                        throw _context2.t0;
