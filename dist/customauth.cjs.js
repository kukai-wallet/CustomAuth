/******/ (() => {
  ...
  (() => {
    ...
    var objectWithoutProperties_default = /*#__PURE__*/ __webpack_require__.n(objectWithoutProperties_namespaceObject); // CONCATENATED MODULE: external "@babel/runtime/helpers/objectSpread2"
    const objectSpread2_namespaceObject = require("@babel/runtime/helpers/objectSpread2");
    var objectSpread2_default = /*#__PURE__*/ __webpack_require__.n(objectSpread2_namespaceObject); // CONCATENATED MODULE: external "base64url"
    const external_base64url_namespaceObject = require("base64url");
    var external_base64url_default = /*#__PURE__*/ __webpack_require__.n(external_base64url_namespaceObject); // CONCATENATED MODULE: external "bowser"
    ...
    class AbstractLoginHandler {
      ...
      get state() {
        return encodeURIComponent(
          external_base64url_default().encode(
            JSON.stringify(
              objectSpread2_default()(
                objectSpread2_default()({}, this.customState || {}),
                {},
                {
      ...
      async handleLoginWindow(params) {
        ...
        if (this.uxMode === UX_MODE.REDIRECT) {
          ...
          const { BroadcastChannel } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 378, 23));
          return new Promise((resolve, reject) => {
    ...
    const external_jwt_decode_namespaceObject = require("jwt-decode"); // CONCATENATED MODULE: ./src/handlers/JwtHandler.ts
    class JwtHandler extends handlers_AbstractLoginHandler {
      ...
      async getUserInfo(params) {
        ...
        if (idToken) {
          const decodedToken = (0, external_jwt_decode_namespaceObject.jwtDecode)(idToken);
    ...
    class CustomAuth {
      ...
      async triggerLogin(args) {
        ...
        if (hash && queryParameters) {
          ...
          // State has to be last here otherwise it will be overwritten
          loginParams = objectSpread2_default()(
            objectSpread2_default()(
              {
                accessToken,
                idToken,
        ...
        if (registerOnly) {
          ...
          return objectSpread2_default()(
            objectSpread2_default()(objectSpread2_default()({}, res), torusPubKey),
            {},
            {
              finalKeyData: objectSpread2_default()(
                objectSpread2_default()({}, torusPubKey.finalKeyData),
                {},
                {
                  privKey: undefined,
                }
              ),
              oAuthKeyData: objectSpread2_default()(
                objectSpread2_default()({}, torusPubKey.finalKeyData),
                {},
                {
                  privKey: undefined,
              ...
              metadata: objectSpread2_default()(
                objectSpread2_default()({}, torusPubKey.metadata),
                {},
                {
                  nonce: undefined,
                }
        ...
        if (checkIfNewKey || skipTorusKey === SkipTorusKey.IfNew) {
          var _lookupData$keyResult, _lookupData$keyResult2, _lookupData$keyResult3;
          ...
          existingPk =
            ...
            (_lookupData$keyResult = _lookupData$keyResult.keys) !== null &&
            _lookupData$keyResult !== void 0 &&
            _lookupData$keyResult.length
              ? {
                  X:
                    lookupData === null ||
                    lookupData === void 0 ||
                    (_lookupData$keyResult2 = lookupData.keyResult) === null ||
                    _lookupData$keyResult2 === void 0
                      ? void 0
                      : _lookupData$keyResult2.keys[0].pub_key_X,
                  Y:
                    lookupData === null ||
                    lookupData === void 0 ||
                    ...
                    _lookupData$keyResult3 === void 0
                      ? void 0
                      : _lookupData$keyResult3.keys[0].pub_key_Y,
                }
              : undefined;
        }
        switch (skipTorusKey) {
        ...
        return objectSpread2_default()(
          objectSpread2_default()({}, torusKey),
          {},
          {
            existingPk,
            userInfo: objectSpread2_default()(objectSpread2_default()({}, userInfo), loginParams),
      ...
      async triggerAggregateLogin(args) {
        ...
        const userInfoArray = _userInfoArray.map((userInfo) =>
          objectSpread2_default()(
            objectSpread2_default()({}, userInfo),
            {},
            {
        ...
        const userInfoData = userInfoArray.map((x, index) => objectSpread2_default()(objectSpread2_default()({}, x), loginParamsArray[index]));
        let skip = true;
        let existingPk;
        if (checkIfNewKey || skipTorusKey === SkipTorusKey.IfNew) {
          var _lookupData$keyResult4, _lookupData$keyResult5, _lookupData$keyResult6;
          const { torusNodeEndpoints } = await this.nodeDetailManager.getNodeDetails({
          ...
          existingPk =
            lookupData !== null &&
            lookupData !== void 0 &&
            (_lookupData$keyResult4 = lookupData.keyResult) !== null &&
            _lookupData$keyResult4 !== void 0 &&
            (_lookupData$keyResult4 = _lookupData$keyResult4.keys) !== null &&
            _lookupData$keyResult4 !== void 0 &&
              ...
              ? {
                  X:
                    ...
                    _lookupData$keyResult5 === void 0
                      ? void 0
                      : _lookupData$keyResult5.keys[0].pub_key_X,
                  Y:
                    lookupData === null ||
                    lookupData === void 0 ||
                    (_lookupData$keyResult6 = lookupData.keyResult) === null ||
                    _lookupData$keyResult6 === void 0
                      ? void 0
                      : _lookupData$keyResult6.keys[0].pub_key_Y,
                }
              : undefined;
        }
        switch (skipTorusKey) {
      ...
      async triggerHybridAggregateLogin(args) {
        ...
        return {
          singleLogin: objectSpread2_default()(
            {
              userInfo: objectSpread2_default()(objectSpread2_default()({}, userInfo), loginParams),
            },
            torusKey1
      ...
      async getTorusKey(verifier, verifierId, verifierParams, idToken, additionalParams) {
        ...
        const sharesResponse = await this.torus.retrieveShares(
          ...
          verifierParams,
          idToken,
          objectSpread2_default()({}, additionalParams)
        );
      ...
      async getRedirectResult() {
        ...
        if (replaceUrl) {
          ...
          window.history.replaceState(
            objectSpread2_default()(
              objectSpread2_default()({}, window.history.state),
              {},
              {
                as: cleanUrl,
                url: cleanUrl,
